                    ...
                    <li class="dropdown profile">
                        ...
                        <div class="dropdown-menu">
                            <div class="profile-info">
                              <h4 class="username">{{ Auth::guard('admin')->user()->username }}</h4>
                            </div>
                            <ul class="action">
                                <li>
                                    <a href="{{ url('/admin/logout_admin') }}"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        Logout
                                    </a>

                                    <form id="logout-form" action="{{ url('/admin/logout_admin') }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </li>
                            </ul>
